...
export default function Home() {
  ...
  return <main>
    ...
    <section className="intro"><p className="kicker">Change the dimensions. Watch the waterline.</p><p>This is a <strong>flat-bottom box model</strong> for comparing design choices. Add a triangular bow only if your team plans to make one.</p><p><a className="tool-link" href="https://dr-kohl.github.io/canoe-layout-planner/">Open the separate Canoe Layout Planner →</a></p></section>
